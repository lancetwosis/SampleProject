...
namespace Redmine.Net.Api.Exceptions
{
    ...
    public class RedmineException : Exception
    {
        ...
        // カスタマイズ(S):422 の場合のエラーの内容を保持するように修正
        /// <summary>
        /// Errors for code 422
        /// </summary>
        ...
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="errors">Errors for code 422</param>
        /// <param name="innerException">The exception that is the cause of the current exception, or a null reference (Nothing in Visual Basic) if no inner exception is specified.</param>
        public RedmineException(string message, IEnumerable<Error> errors, Exception innerException)
            : base(message, innerException)
        {
            Errors = errors;
        }
        // カスタマイズ(E):422 の場合のエラーの内容を保持するように修正
