...
{
    public class ChildIssueFilterViewModel : TextIssueFilterViewModelBase<ChildIssueFilterModel>
    {
        public ChildIssueFilterViewModel(ChildIssueFilterModel model) : base(model)
        {
        }
    }
}
