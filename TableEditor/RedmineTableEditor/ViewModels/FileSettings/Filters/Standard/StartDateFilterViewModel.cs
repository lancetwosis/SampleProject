...
{
    public class StartDateFilterViewModel : DateFilterViewModelBase<StartDateFilterModel>
    {
        public StartDateFilterViewModel(StartDateFilterModel model) : base(model)
        {
        }
    }
}
