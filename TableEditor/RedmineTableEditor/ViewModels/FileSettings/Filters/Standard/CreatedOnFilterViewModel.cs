...
{
    public class CreatedOnFilterViewModel : DateFilterViewModelBase<CreatedOnFilterModel>
    {
        public CreatedOnFilterViewModel(CreatedOnFilterModel model) : base(model)
        {
        }
    }
}
