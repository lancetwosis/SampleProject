...
{
    public class LastUpdaterFilterViewModel : UserFilterViewModelBase<LastUpdaterFilterModel>
    {
        public LastUpdaterFilterViewModel(LastUpdaterFilterModel model) : base(model)
        {
        }
    }
}
