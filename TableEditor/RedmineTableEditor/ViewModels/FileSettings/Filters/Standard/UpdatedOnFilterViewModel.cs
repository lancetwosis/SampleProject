...
{
    public class UpdatedOnFilterViewModel : DateFilterViewModelBase<UpdatedOnFilterModel>
    {
        public UpdatedOnFilterViewModel(UpdatedOnFilterModel model) : base(model)
        {
        }
    }
}
