...
{
    public class DescriptionFilterViewModel : TextFilterViewModelBase<DescriptionFilterModel>
    {
        public DescriptionFilterViewModel(DescriptionFilterModel model) : base(model)
        {
        }
    }
}
