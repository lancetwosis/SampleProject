...
{
    public class StatusFilterViewModel : ItemsFilterViewModelBase<StatusFilterModel>
    {

        public StatusFilterViewModel(StatusFilterModel model) : base(model)
        {
        }
        ...
        public override void Setup(RedmineManager redmine, ReadOnlyReactivePropertySlim<List<FilterItemModel>> _ = null)
        {
            ...
            var allItems = redmine.Cache.Statuss.Select(a => new FilterItemModel(a)).ToList();
