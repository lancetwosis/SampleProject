...
{
    public class ParentIssueFilterViewModel : TextIssueFilterViewModelBase<ParentIssueFilterModel>
    {
        public ParentIssueFilterViewModel(ParentIssueFilterModel model) : base(model)
        {
        }
    }
}
