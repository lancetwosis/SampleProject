...
{
    public class CfTextSearchFilterViewModel : TextFilterViewModelBase<CfTextSearchFilterModel>
    {
        public CfTextSearchFilterViewModel(CfTextSearchFilterModel model) : base(model)
        {
        }
    }
}
