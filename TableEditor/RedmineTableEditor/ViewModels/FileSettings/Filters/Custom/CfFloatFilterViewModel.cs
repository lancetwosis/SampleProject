...
{
    public class CfFloatFilterViewModel : NumericFilterViewModelBase<CfFloatFilterModel, float>
    {
        public CfFloatFilterViewModel(CfFloatFilterModel model) : base(model)
        {
        }
    }
}
