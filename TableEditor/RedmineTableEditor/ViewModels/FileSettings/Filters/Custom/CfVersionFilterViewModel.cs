...
{
    public class CfVersionFilterViewModel : VersionFilterViewModelBase<CfItemsFilterModel>
    {
        public CfVersionFilterViewModel(CfItemsFilterModel model, RedmineManager redmine, ReadOnlyReactivePropertySlim<List<FilterItemModel>> projects) : base(model)
        {
