...
{
    public class TextSearchFilterModelBase : TextFilterModelBase
    {
        public TextSearchFilterModelBase()
        {
        }

        public TextSearchFilterModelBase(string name, string key) : base(name, key)
        {
        ...
        public override void SetDefaultCompareType()
        {
            CompareType = CompareTypeModel.CONTAINS;
        }
    }
}
