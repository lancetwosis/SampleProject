...
{
    public class StartDateFilterModel : DateFilterModelBase
    {
        public StartDateFilterModel() : base(Resources.enumIssuePropertyTypeStartDate, RedmineKeys.START_DATE, true)
        {
        }
    }
}
