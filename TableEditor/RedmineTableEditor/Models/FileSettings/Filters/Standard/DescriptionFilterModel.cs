...
{
    public class DescriptionFilterModel : TextSearchFilterModelBase
    {
        public DescriptionFilterModel() : base(Resources.enumIssuePropertyTypeDescription, RedmineKeys.DESCRIPTION)
        {
        }
    }
}
