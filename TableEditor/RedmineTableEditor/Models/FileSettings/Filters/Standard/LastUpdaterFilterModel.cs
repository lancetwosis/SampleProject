...
{
    public class LastUpdaterFilterModel : UsersFilterModelBase
    {
        public LastUpdaterFilterModel() : base(Resources.enumIssuePropertyTypeLastUpdater, RedmineKeys.LAST_UPDATED_BY, true)
        {
        }
    }
}
