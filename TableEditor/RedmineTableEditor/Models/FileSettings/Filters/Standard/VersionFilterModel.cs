...
{
    public class VersionFilterModel : ItemsFilterModelBase
    {
        public VersionFilterModel() : base(Resources.enumIssuePropertyTypeFixedVersion, RedmineKeys.FIXED_VERSION_ID, false)
        {
        }
    }
}
