...
{
    public class StatusFilterModel : ItemsFilterModelBase
    {
        public StatusFilterModel() : base(Resources.enumIssuePropertyTypeStatus, RedmineKeys.STATUS_ID, true)
        {
            CompareTypes = new List<CompareTypeModel>()
            {
                CompareTypeModel.OPEN,
                CompareTypeModel.EQUALS,
                CompareTypeModel.NOT_EQUALS,
                CompareTypeModel.CLOSED,
            };
        }

        public override void SetDefaultCompareType()
        {
            CompareType = CompareTypeModel.OPEN;
        }
    }
}
