...
{
    public class AssigneeFilterModel : UsersFilterModelBase
    {
        public AssigneeFilterModel() : base(Resources.enumIssuePropertyTypeAssignedTo, RedmineKeys.ASSIGNED_TO_ID, false)
        {
        }
    }
}
