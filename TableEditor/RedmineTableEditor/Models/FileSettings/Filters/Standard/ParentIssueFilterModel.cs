...
{
    public class ParentIssueFilterModel : TextIssueFilterModelBase
    {
        public ParentIssueFilterModel() : base(Resources.FileSettingsParentIssue, RedmineKeys.PARENT_ID)
        {
        }
    }
}
