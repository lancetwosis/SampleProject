...
{
    public class IssueCategoryFilterModel : ItemsFilterModelBase
    {
        public IssueCategoryFilterModel() : base(Resources.enumIssuePropertyTypeCategory, RedmineKeys.CATEGORY_ID, false)
        {
        }
    }
}
