...
{
    public class CfFloatFilterModel : NumericFilterModelBase<float>
    {
        public CustomField CustomField { get; set; }

        public CfFloatFilterModel()
        {
        }

        [JsonConstructor]
        public CfFloatFilterModel(CustomField customField)
        ...
        {
            if (value == null || !float.TryParse(value, out var _))
            {
                errMsg = Properties.Resources.FilterErrMsgInputNumber;
                return false;
            }
            else
            {
