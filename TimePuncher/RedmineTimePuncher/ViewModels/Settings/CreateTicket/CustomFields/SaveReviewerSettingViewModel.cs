...
{
    public class SaveReviewerSettingViewModel : ListCustomFieldSettingViewModelBase<MyCustomField, MyCustomFieldPossibleValue>
    {
        public SaveReviewerSettingViewModel(CustomFieldSettingModelBase model) : base(model, true)
        {
        }
    }
}
