...
namespace RedmineTimePuncher.ViewModels.CreateTicket.Review.CustomFields
{
    ...
    {
        public PointCustomFieldsViewModel(CustomFieldsModel customFields, TargetTicketModel target)
            : base(Resources.SettingsReviPointTicket, customFields.Point, target)
        {
        }

        protected override MyTracker getTracker()
        {
            return SettingsModel.Default.CreateTicket.PointTracker;
        }
    }
}
